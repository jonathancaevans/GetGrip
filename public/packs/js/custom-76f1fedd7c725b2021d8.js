...
/* WEBPACK VAR INJECTION */(function($) {$(document).on('turbolinks:load', function () {
  $('body').on('select2:select', function (e) {
    console.log($('.color').find(':selected').text()); //var chart = Chartkick.charts["chart-1"];
    //chart.updateData($('.color').find(':selected').text())
  });
...
/******/ });
//# sourceMappingURL=custom-76f1fedd7c725b2021d8.js.map