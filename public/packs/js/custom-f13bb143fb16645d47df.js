...
/* WEBPACK VAR INJECTION */(function($) {$(document).on('turbolinks:load', function () {
  ...
  $('body .color').on('select2:select', function (e) {
    console.log("Color running here");
  ...
  }); //Grade set ajax update

  $('body .grade').on('select2:select', function (e) {
    var grades = new Array();
    var x = 0;
    $('.grade').find(':selected').each(function (index) {
      var i;
      var newGrade = true;
...
/******/ });
//# sourceMappingURL=custom-f13bb143fb16645d47df.js.map