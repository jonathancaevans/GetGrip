...
/* WEBPACK VAR INJECTION */(function($) {$(document).on('turbolinks:load', function () {
  $('body').on('select2:select', function (e) {
    ...
    $('.color').find(':selected').each(function (index) {
      ...
      color.data[$(this).text()] = 1;
      colors[index] = color;

      if ($(this).text() in colors) {//colors[$(this).text()] = colors[$(this).text()] + 1;
      } else {//colors[$(this).text()] = 1;
          //data[0].data["Tuesday"]
          //var data = [{name: "v2", data: {"Tuesday": 3}, color: "red"}, {name: "v1", data: {"Tuesday": 3}, color: "blue"}]
        }
    });
    console.log(colors);
...
/******/ });
//# sourceMappingURL=custom-4244c03d569a2413b61c.js.map