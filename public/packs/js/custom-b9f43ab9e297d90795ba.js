  ...
  $('body').on('select2:select', function (e) {
    ...
    $('.color').find(':selected').each(function (index) {
      if ($(this).text() in colors) {
        colors[$(this).text()]["data"] = colors[$(this).text()].data + 1;
      } else {
        colors[$(this).text()]["data"] = 1;
        colors[$(this).text()]["color"] = $(this).text();
      }
    });
...
/******/ });
//# sourceMappingURL=custom-b9f43ab9e297d90795ba.js.map